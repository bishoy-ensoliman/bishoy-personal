...
import personalPic from '../../../public/portraitMe.jpeg';
                            ...
                            <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
                                <div className="lg:pl-20">
                                    <div className="max-w-xs px-2.5 lg:max-w-none">
                                        <Image alt="" className="aspect-square rotate-3 rounded-2xl bg-zinc-100 object-cover dark:bg-zinc-800"
                                            src={personalPic} />
                                    </div>
                                </div>
                                ...
                                <div className="lg:pl-20">
                                    <ul role="list">
                                        <li className="flex">
                                            <a className="group flex text-sm font-medium text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500" target='_blank' href="https://www.instagram.com/bishoy.ensoliman/">
                                        ...
                                        <li className="mt-4 flex">
                                            <a className="group flex text-sm font-medium text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500" target='_blank' href="https://github.com/bishoy-ensoliman">
                                                <svg viewBox="0 0 24 24" className="h-6 w-6 flex-none fill-zinc-500 transition group-hover:fill-teal-500">
                                        ...
                                        <li className="mt-4 flex">
                                            <a className="group flex text-sm font-medium text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500" target='_blank' href="https://www.linkedin.com/in/bishoy-soliman">
                                                <svg viewBox="0 0 24 24" className="h-6 w-6 flex-none fill-zinc-500 transition group-hover:fill-teal-500">
                                        ...
                                        <li className="mt-8 border-t border-zinc-100 pt-8 dark:border-zinc-700/40 flex">
                                            <a className="group flex text-sm font-medium text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500" href="mailto:contact@bishoysoliman.com">
                                                ...
                                                <span className="ml-4">contact@bishoysoliman.com</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
