                                ...
                                <div className="lg:pl-20">
                                    <ul role="list">
                                        ...
                                        <li className="mt-8 border-t border-zinc-100 pt-8 dark:border-zinc-700/40 flex">
                                            <a className="group flex text-sm font-medium text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500" href="mailto:me@bisaak.com">
                                                ...
                                                <span className="ml-4">me@bisaak.com</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
