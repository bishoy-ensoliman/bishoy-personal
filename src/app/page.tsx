    ...
    <div>
      ...
      <main className="flex-auto">
              ...
              <div className="mx-auto max-w-2xl lg:max-w-5xl">
                <div className="max-w-2xl">
                  <h1 className="text-xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-xl">
                    Aerospace Engineer | Computer & Systems Engineer | Microelectronics & Chip Designer | MBA
                  </h1>
                  ...
                  <div className="mt-6 flex gap-6">
                    ...
                    <a className="group -m-1 p-1" target='_blank' href="https://www.linkedin.com/in/bishoy-isaak/">
                      <svg viewBox="0 0 24 24" className="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
                        <path
        ...
        <div className="mt-16 sm:mt-20 flex justify-center">
          <div className="flex gap-5 overflow-x-scroll overflow-y-hidden py-4 sm:gap-8 px-4">
            <div
